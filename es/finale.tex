...
\hreffoot{https://ciudadseva.com/texto/por\-que\-escribo/}{George Orwell} escribió:
\index{Orwell, George}

\begin{quote}

  En una época pacífica podría haber escrito libros ornamentales o simplemente descriptivos
  y casi no habría tenido en cuenta mis lealtades políticas.
  Pero me he visto obligado a convertirme en una especie de panfletista.{\ldots}
  Cada línea seria que he escrito desde 1936 lo ha sido, directa o indirectamente,
  contra el totalitarismo{\ldots}
  Me parece una tontería, en un periodo como el nuestro, creer que puede uno evitar escribir sobre esos temas.
  Todas las personas escriben al respecto de un modo u otro. 
  Es sencillamente cuestión del bando que uno toma y de cómo se entra en él.
