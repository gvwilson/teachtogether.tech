...
el \gref{g:marketing}{marketing} se trata sobre confundir y engañar. 
...
la persona tipo, similar al estudiante tipo\index{learner persona}
...
Un paso crucial es lograr que tu organización sea encontrada en las búsquedas en línea. \index{findability!of organizations}
...
Hay mucho mito sobre técnicas para hacer que las cosas puedan ser encontradas en internet (lo que a veces se refiere como\gref{g:seo}{motor de optimización de posicionamiento en buscadores} o SEO por su sigla en inglés, \emph{``search engine optimization''}). 
...
entonces puedes leer \hreffoot{https://moz.com/learn/seo/on-page-factors}{estas guías}
...
aquellos que trabajan con grupos económicamente desfavorecidos muy probablemente no los tengan.
 (Como Rosario Robinson dice, ``Gratis funciona para aquellos para que pueden permitirse lo gratuito.'')\index{Robinson, Rosario}
...
Recuerda la regla  90-9-1-- el 90% va a mirar, el 9% va a hablar y el 1% realmente va a hacer cosas---ajusta tus expectativas de modo acorde.
...
\hreffoot{https://www.insidehighered.com/news/2017/07/06/anthropologist-studies-why-professors-dont-adopt-innovative-teaching-methods}{por qué los/las profesores/as de las universidades no adoptan mejores metodos de enseñanza}.
...
\exercise{Discurso de presentación para un miembro del concejo de la ciudad}{individual}{10'}
...
Revisa el ejercicio ``¿Por qué aprender a programar?'' en \secref {s:intro-exercises}.
¿Dónde se alinean tus razones para enseñar y las razones de tus estudiantes para aprender?
¿Dónde no se alinean?
¿Cómo afecta eso a tu marketing?

\exercise{Programadores/as conversacionales}{pensar en parejas y compartir}{15'}
...
dada en \secref{s:outreach-schools}.
...
El \hreffoot{http://www.iaamcs.org/}{Institute for African-American Mentoring in Computer Science} (Instituto de mentoría afroamericana en ciancias de la computación)
