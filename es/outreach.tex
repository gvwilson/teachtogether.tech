...
las personas tipo \index{learner persona}
...
\begin{quote}
  ...
  quiénes \emph{tienen dificultades para encontrar candidatos con suficiente madurez en diversas formaciones}
  nuestros \emph{talleres introductorios de programación}
...
Si no sabes por qué diferentes patrocinadores potenciales podrían estar interesados/as en lo que haces,
pregúntales.
Si lo sabes,
pregúntales igual:
...
Algunas personas podrían ofrecerse a enseñar de forma voluntaria contigo  
porque sus amistades lo están haciendo. Igualmente, una empresa puede decir que 
está patrocinando clases para estudiantes de secundaria desfavorecidos/as económicamente 
porque quieren tener un grupo más grande de empleados potenciales en el futuro, 
aunque quizás quien dirije la empresa lo podría estar haciendo, simplemente porque es lo correcto.
...
Una de ellas es usar ejemplos de éxito con como un robot que una de tus estudiantes 
...
Con esa inforamción puedes leer \hreffoot{https://moz.com/learn/seo/on-page-factors}{estas guías}
...
sólo podrías inspirarles a ser buenas personas también.
...
podrás pedir (y tener éxito) en obtner un compromiso 
futuro de las personas más ocupadas.
Si se les da algún tiempo de anticipación, 
es posible que estén más dispuestos a ayudar
