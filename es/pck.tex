...
\item[La mayoría de las personas en estos estudios
  ...
  así como sobre \grefdex{g:end-user-programmer}{usuarias/os finales programadoras/es}{usuario/a final programadora/or},
...
\begin{aside}{Computación sin código}
  ...
  Este tipo de enseñanza a veces es llamada \grefdex{g:cs-unplugged}{CS desenchufada}{ciencias de la computación desenchufada};
