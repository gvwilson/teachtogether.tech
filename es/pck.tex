...
La mayor confusión de las personas novatas ---a veces llamada el \emph{``superbug''} o ``supererror'' en programación ---es\index{\emph{superbug}} \index{supererror}
...
usando herramientas basadas en bloques como Scratch (\figref{f:pck-scratch})~\cite{Wein2017}.\index{emph\{Scratch}}
...
que estudiaron a personas novatas aprendiendo sobre bucles en Scratch, Logo y Python.\index{emph\{Scratch}}\index{emph\{Python}}
...
\begin{aside}{Más difícil de lo necesario}
  ...
  pero que la sintaxis de lenguajes como Python y Ruby\index{emph\{Python}}\index{emph\{Ruby}}
...
\cite{Mill2016b} encontró que la mayoría de las personas novatas que usan Python\index{emph\{Python}}
...
(por ejemplo,\ \hreffoot{https://www.python.org/dev/peps/pep-0008/}{PEP 8} para \emph{Python} \index{emph\{Python}})
...
y herramientas como el tutor de Python\index{emph\{Python}} en línea~\cite{Guo2013}
