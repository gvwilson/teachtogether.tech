...
\seclbl{¿Cuán están aprendiendo?}{s:pck-learning}
...
i.e.\ que llamar a una variable ``precio'' no garantiza que su valor sea realmente un precio.
...
\item
  ...
  i.e.\ recuerda que valor supo representar.
...
\item
  ...
  i.e.\ después de \texttt{a\ =\ b}, la variable \texttt{b} está vacía.
...
Algunos errores, en cambio, se repiten muchas veces, como llamar metodos con los agumentos incorrectos
(ej.\ pasar una cadena caracteres en vez de un enero).
