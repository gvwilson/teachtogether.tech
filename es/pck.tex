...
\item[Las teorías cambian a medida que se obtienen más datos.]
  La investigación en educación en informática (CER, por Computing education research en inglés) es una diciplina nueva:\index{computing education research}
...
\seclbl{¿Qué conceptos erróneos tiene las personas novatas?}{s:pck-misunderstand}

\chapref{s:models} explicó porqué aclarar los errores erróneos de las personas novatas es tan importante como enseñarles
...
\seclbl{¿Qué errores comenten las personas novatas?}{s:pck-mistakes}
...
\emph{y} tiene un conjunto de patrones o plan que guía su construcción.\index{program patterns}
...
\seclbl{¿Cómo resuelven errores las personas novatas?}{s:pck-debug}
...
Nuestra quinta recomendación es entonces \recommendation{enseñar explicitamente a las personas principiantes como depurar errores}.
...
y muchas/os docentes promueven un enfoque \gref{g:objects-first}{primero objetos} para enseñar a programar
...
\recommendation{usar herramientras para garantizar que todos los ejemplos de código se adhieran a un estilo consistente}.
...
Un posible elemento de confución que revisaron es el tiempo:
...
\item[Computación de medios:]
  Actividades que usen explicitamente el uso de la computación de medios (\chapref{s:motivation}).
...
mientras escribía este libro.\index{illegal downloading (mine)}
...
El sitio \hreffoot{http://www.pd4cs.org/}{Desarrollo Profesional para la Enseñanza de Princiios de CS} 
incluye \hreffoot{http://www.pd4cs.org/mc-index/}{una lista desatallada de conceptos erróneos de estudiantes y ejercicios}.
Trabajando en grupos pequeños,
