...
\gitem{g:scaffolding}{Andamiaje} Se proporciona material adicional a las/los estudiantes
...
aprendizaje que enfatiza el proceso de la persona que enseña que transmite habilidades e ideas
...
\gitem{g:cs-unplugged}{Ciencias de la computación desconectada} Un estilo de enseñanza que introduce
conceptos informáticos utilizando ejemplos y artefactos que no son de programación.

\gitem{g:synchronous}{Clase sincrónica} tanto la/el docente como las/los estudiantes se conectan 
a un espacio común virtual al mismo tiempo e interactúan en tiempo real. 

\gitem{g:asynchronous}{Clase asincrónica} la interacción y comunicación de estudiantes y docentes
...
\gitem{g:contributing-student-pedagogy}{Contribuyendo a la pedagogía estudiantil} Tener a las/los estudiantes
...
\gitem{g:mooc}{Cursos masivos en línea} (\emph{MOOC}, por sus siglas en Inglés) Un curso en línea diseñado para la inscripción masiva y el estudio asíncrono, que generalmente usa videos grabados y calificaciones automáticas.
...
\gitem{g:faded-example}{Ejemplo desvanecidos} Una serie de ejemplos en los que
...
\gitem{g:learned-helplessness}{Indefensión aprendida} Una situación en la que, las personas que son sometidas repetidamente a 
...
\gitem{g:commons}{Los Comunes} algo gestionado conjuntamente por una comunidad
...
\gitem{g:mooc-sigla}{MOOC} Ver \grefcross{g:mooc}{cursos masivos en linea}.
...
\gitem{g:guided-notes}{Notas guiadas} Notas preparadas por la/el docente, para sus estudiantes, que donde se destaca la 
...
\gitem{g:pair-programming}{Programación en pareja} Una práctica de desarrollo de software en la que 
...
\gitem{g:learning-outcome}{Resultado de aprendizaje} Qué es lo que la lección realmente logra enseñar.
