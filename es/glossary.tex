...
\gitem{g:absolute-beginner}{Principiante real} Alguien que nunca se ha
...
\gitem{g:active-learning}{Aprendizaje activo} Un enfoque de la instrucción en el que
...
\gitem{g:backward-design}{Diseño hacia atrás} Un método de diseño instruccional que
...
\gitem{g:behaviorism}{Comportamiento} Una teoría del aprendizaje cuyo principio central
...
\gitem{g:blooms-taxonomy}{Taxonomía de Bloom} Una jerarquía de seis partes
clasificación de comprensión cuyos niveles son \ emph {conocimiento},
\emph{comprensión}, \emph{aplicación}, \emph{análisis}, \emph{síntesis} y
\emph{evaluación} que ha sido ampliamente adoptado. 
...
revisiones del trabajo de muestra con las de un maestro antes de que 
...
\gitem{g:co-teaching}{Co-enseñanza} Enseñanza con otro maestro en el
salón de clases.
...
aprendizaje que enfatiza el proceso de un maestro que transmite habilidades e ideas
situacionalmente a un aprendiz.
