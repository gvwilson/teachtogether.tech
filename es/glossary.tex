...
\gitem{g:flipped-classroom}{Aula invertida} One in which learners watch
recorded lessons on their own time, while class time is used to work through
problem sets and answer questions.

\gitem{g:flow}{Flujo} The feeling of being fully immersed in an activity;
frequently associated with high productivity.

\gitem{g:fluid-representation}{Representación fluida} The ability to move
quickly between different models of a problem.

\gitem{g:formative-assessment}{Evaluación formativa} Assessment that takes
...
\gitem{g:free-range-learner}{Estudiante free-range} Someone learning outside an
...
practice. Ver también \grefcross{g:fixed-mindset}{fixed mindset}.
...
slow. Ver también \grefcross{g:short-term-memory}{short-term memory}.
...
a domain. Ver también \grefcross{g:competent-practitioner}{competent practitioner}
