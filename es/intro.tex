...
a \grefdex{g:free-range-learner}{estudiantes free-range\footnote{Nota de la editora: el autor inventó el término "free-range" 
...
El autor también se refiere a las/os estudiantes 
...
Por favor consulta \appref{s:joining} para detalles
y \appref{s:conduct} para conocer nuestro código de conducta. 
\end{aside}

\seclbl{¿Quién eres?}{s:intro-audience}

La \secref{s:process-personas} explica cómo averiguar quiénes son tus estudiantes. Los cuatro tipos de personas a las que está destinado este libro son usuarias/os finales docentes: la enseñanza no es su ocupación primaria, tienen poco o ningún conocimiento sobre pedagogía y posiblemente trabajan fuera de clases institucionales.
...
y en gran medida siente el \gref{g:impostor-syndrome}{síndrome de la impostora}.
...
\item
 \hreffoot{http://carpentries.github.io/instructor-training/}{El entrenamiento para instructoras/es de The Carpentries (Las Carpentries)},
 en el cual está basado este libro. 
\item
 \cite{Lang2016} y~\cite{Hust2012}, que son textos cortos y accesibles, que conectan las cosas que puedes aplicar inmediatamente con la investigación que hay detrás de ellas y las fundamenta. 
