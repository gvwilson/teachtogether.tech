...
a \grefdex{g:free-range-learner}{free-range learners}{free-range learner}.
...
en cualquier clase
(gratuita o paga),
y puedes citar pequeños extractos bajo el criterio de \hreffoot{https://es.wikipedia.org/wiki/Uso_justo}{uso justo},
...
\item
  \hreffoot{http://carpentries.github.io/instructor-training/}{El entrenamiento para instructores/as de las Carpentries},
...
mientras que \hreffoot{http://computinged.wordpress.com}{el blog de Mark Guzdial} ha sido consistentemente informativo, provocativo y motivador.
...
\exercise{Conócete a tí mismo/a}{clase completa}{5}
