...
\item
 ...
 mayor cantidad de conexiones entre hechos hace más fácil razonar hacia atrás, de síntomas a causas.
  (Esta es la razón por la cual durante una entrevista de trabajo es preferible pedirle a programadoras/es que depuren un programa a pedirles que programen: da una impresión más precisa de su habilidad.)
...
\figpdf{figures/for-loop.pdf}{Mapa conceptual para un bucle \texttt{for} }{f:memory-loop}
...
Todos estos esquemas \grefdex{g:externalized-cognition}{externalizan la cognición}{externalized cognition},
...
\begin{aside}{Trabajo crudo y honestidad}
  Muchas/os diseñadoras/es de interfaces de usuario creen que es mejor mostrar bocetos de sus ideas en lugar de maquetas pulidas,
...
\figpdf{figures/photosynthesis.pdf}{El uso de mapas conceptuales en el diseño de la lección}{f:memory-photosynthesis}
...
es tentador identificar \hreffoot{https://es.wikipedia.org/wiki/Patrón\_de\_diseño}{design patterns}\index{patrones de diseño}
...
Volveremos a este tema en \secref{s:pck-programming}.
