...
considera este \texttt{for} bucle en \emph{Python}:\index{Python}
...
La primera,
llamada \grefdex{g:long-term-memory}{memoria a largo plazo}
...
llamado \grefdex{g:short-term-memory}{memoria a corto plazo}
...
Esto se llama \grefdex{g:deliberate-practice}{práctica deliberada}
...
\item[Darse devoluciones a si misma/o.]
  En algún punto,
...
Vuelve al mapa conceptual para la fotosíntesis en la \figref{f:memory-photosynthesis}.
