...
\begin{quote}
  ...
  --- Daniel Willingham\index{Willingham, Daniel}, \emph{Por qué a tus estudiantes no les gusta la escuela(Why Students Don't Like School)}
...
\item
 ...
 p.ej.\ sus habilidades para cambiar una y otra vez entre distintas formas de ver un problema~\cite{Petr2016}.
  Por ejemplo,
...
considera este \texttt{for} bucle en Python:\index{Python}
...
Los tres ``cosas'' clave en este bucle se muestran al principio de \figref{f:memory-loop},
...
\figpdf{figures/for-loop.pdf}{Mapa conceptual para un \texttt{for} bucleloop}{f:memory-loop}
...
\item[Para mejorar la comunicación con estudiantes.]
  Si bien es posible dar a quienes estudian un mapa pre-dibujado al inicio de la lección para que puedan anotar,
  es mejor dibujarlo parte por parte mientras se está enseñando,
  para reforzar la relación entre lo que muestra el mapa y lo que dice quien enseña.
...
\item[Para evaluación.]
  ...
  le muestra a quien enseña lo que se perdieron y lo que se comunicó mal.
  ...
  cualquier manera nueva de hacer algo inicialmente enlenteceralentiza a la gente---si quien está aprendiendo intenta una/un estudiante está tratando de encontrarle el sentido a la programación básica,
...
Todos ellos \grefdex{g:externalized-cognition}{externalizan la cognición}{externalized cognition},
...
es donde almacenamos cosas como los nombres de nuestras/os amigas/os,
nuestra dirección,
...
Quien enseñaUn docente no puede colocar información directamente en la memoria a largo plazo de una/unun estudiante.
En cambio,
...
Si quien enseñala/el docente presenta demasiada información y muy rápidamente,
...
la/elel docente elegirá un fragmento que se ajuste para la memoria a corto plazo y continuará con una evaluación formativa (\figref{f:memory-photosynthesis}),\index{evaluación formativa}
...
es tentador identificar \hreffoot{https://es.wikipedia.org/wiki/Patrón_de_diseñohttps://en.wikipedia.org/wiki/Software\_design\_pattern}{design patterns}\index{patrones de diseño}
...
\item[Actuar según la devolución de otros.]
  ...
  y recibir devoluciones de una/un docente enseñante que les diga cómo mejorarlo.
...
\item[Dar devoluciones sobre el trabajo de otros.]
  ...
  y recibir una devolución de una/un docente enseñante sobre esas críticas.

\item[Darse devoluciones a una/osí misma/oos.]
  En algún punto,
  las/los estudiantes empiezan a criticar sus propios trabajos como lo hacenían 
  usando las habilidades que ahora han construiído.
  Hacer esto es mucho más rápido que esperar los comentarios de otras personasos 
  que esta competencia de pronto empieza a despegar.
...
\begin{aside}{¿Qué cuenta como práctica deliberada?}
 ...
 implica que el impacto de todos los tipos de actividad práctica respecto a  rendimiento es igual ------una suposición
  ...
  Se trata de dosambas son cosas que las/los docenteslos enseñantes, de cualquier manera, deberían esforzarse en conseguir.
\end{aside}
...
Discutan con tu colega y critiquen el mapa que cada cual elaboróde cada uno.
...
\figpdfhere{figures/chunking-unchunked.pdf}{representación no fragmentada}{f:memory-unchunked}
