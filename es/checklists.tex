...
Encontramos útiles las listas de verificación,
...
Responde tres o cuatro de las preguntas a continuación sólo enumerando elementos
...
Establezca los objetivos del Paso 2 escribiendo descripciones detalladas de
algunos ejercicios que las/los estudiantes serán capaces de resolver al final de la lección.
Hacer esto es análogo a \hreffoot{https://en.wikipedia.org/wiki/Test-driven\_development}{test-driven development}:
...
~\\
\noindent
\textbf{Ejercicio breve:} 1--2 ejercicios explicados de principio a fin
que usen las habilidades que las/los estudiantes van a aprender,
...
El esquema debe tener 3--4 ítems por hora de clase
