...
\item
  ...
  programar en vivo asegura que puedan ver cómo hacer esto.
...
pero la mayoría de las personas indican que rápidamente se vuelve igual de difícil que hablar alrededor de una presentación de diapositivas.
...
es importante decirle a las personas cuando estás usas un editor de texto en la consola
...
\begin{quote}
  ...
  Para graduarse,
  los especialistas en educación [japoneses] no solo tenían que ver como trabaja el/la docente que le asignan,
  tenían que reemplazarlo/a efectivamente,
  participando en su aula primero como observadores/as y luego,
  a la tercera semana,
  como una aproximación{\ldots}titubeante del propio docente.
...
y dar \grefdex{g:demonstration-lesson}{lecciones de demostración}{demonstration lesson}
...
\begin{quote}
  ...
  No es probable que docentes utilicen los resultados de investigaciones en educación
...
\figpdf{figures/2x2-rubric.pdf}{Rúbrica de enseñanza}{f:performance-rubric}
...
\begin{aside}{Clases de estudio}
  Las escuelas de arquitectura a menudo incluyen clases de estudio\index{studio class}
...
También es una buena preparación para enseñar de a pares (\secref{s:classroom-together}):\index{co-teaching}
...
En grupo,
miren \hreffoot{https://www.youtube.com/watch?v=-ApVt04rB4U}{este video de mala enseñanza}
...
\exercise{Observa, luego hace}{de a pares}{30'}
...
\figpdfhere{figures/conceptmap-feedback.pdf}{Conceptos: Retroalimentación}{f:performance-feedback}
