...
\hreffoot{https://es.wikipedia.org/wiki/Bordillo}{Los Bordillos}---las pequeñas rampas inclinadas que unen una acera a la calle---
...
\begin{aside}{Conducta como accesibilidad}
  Dijimos en \secref{s:classroom-coc} que las clases deberían hacer cumplir un Código de Conducta como el de \appref{s:conduct}.
