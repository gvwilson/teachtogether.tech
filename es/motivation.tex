...
y \greg{g:intrinsic-motivation}{motivación intrínseca},
...
\item[Competencia:]
  la sensación de que sabes lo que haces. \index{motivation!competence}

\item[Autonomía:]
  la sensación de estar en control de tu propio destino.\index{motivation!autonomy}

\item[Relación:]
  la sensación de estar conectada/o con los/las demás.\index{motivation!relatedness}
...
\begin{aside}{No solo para estudiantes}
  Discusiones de motivación en educación con frecuencia sobrepasan la necesidad de motivar al/la \emph{docente}.\index{motivation!of teachers}
...
Las cosas que \emph{no} impulsaron la retención
...
si el estudio hubiera concluido que realizar actividades extracurriculares juntos/as impulsan la retención,
también pensaríamos que tiene sentido.
Notablemente,
dos de los cuatro impulsores de retención (interacción del cuerpo docente y colaboración entre estudiantes)
toman un esfuerzo adicional para replicarlos en línea (\chapref{s:online}).
...
porque unas pocas victorias tempranas fortalecerán la confianza de los/las estudiantes en sí mismas y en su docente.
Por el contrario.
cosas que son difíciles de aprender y no son útiles a tus estudiantes en su etapa actual de desarrollo
deben omitirse por completo,
mientras que temas en la diagonal se deben sopesar entre sí.

\newpage
\being{aside}{¿Útil para quién?}
  ...
  Eso no quiere decir que no vale la pena aprenderlo,
  pero si nuestro objetivo es motivar a las personas,
  pueden y deben ser diferidos.
  Por lo contrario,
  ...
  Si los temas terminan en diferentes lugares para diferentes personas,
...
\item[Indiferencia]
  ...
  no se van a preocupar por aprender el material.\index{demotivation!indifference}
...
\cite{Ford2016} encontró que cinco barreras para contribuir en \hreffoot{https://stackoverflow.com/}{Stack Overflow}
...
\grefdex{g:impostor-syndrome}{Síndrome del impostor/a}{síndrome del impostor/a}
...
\hreffoot{https://educhatter.wordpress.com/2017/03/26/growth-mindset-is-the-theory-flawed-or-has-gm-been-debased-in-the-classroom/}{Hay preocupación}
...
\hreffoot{https://es.wikipedia.org/wiki/Bordillo}{Los Bordillos}---las pequeñnas rampas inclinadas que unen una acera a la calle---fueron
...
\item[Descubrea lo que debes hacer.]
   Cada uno de \hreffoot{https://github.com/UKHomeOffice/posters/tree/master/accessibility/dos-donts/posters_es}{estos afiches}
...
\grefdex{g:inclusivity}{Inclusión}{inclusión} es una política para
...
Lee \hreffoot{https://mobile.nytimes.com/2016/04/10/upshot/why-talented-black-and-hispanic-students-can-go-undiscovered.html}{este artíiculo}
de Cameron Cottrill,
...
\hreffoot{https://www.destroyallsoftware.com/blog/2018/a-case-study-in-not-being-a-jerk-in-open-source}{Este artíiculo corto}
de Gary Bernhardt
...
\hreffoot{https://github.com/UKHomeOffice/posters/tree/master/accessibility/dos-donts/posters_es}{estos afiches}.
