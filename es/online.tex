...
\begin{aside}{Confía, pero educa}
  ...
  es comparar las calificaciones de los alumnos con las calificaciones de los expertos,
  pero revisión por pares calibrada (\secref{s:individual-peer}) puede ser igualmente efectiva.
  \index{calibrated peer review}
  Antes de pedir a los/as estudiantes que califiquen el trabajo del resto,
  se les pide que califiquen muestras y comparen sus resultados con las calificaciones asignadas por el/la docente.
  ...
  este resultado puede apuntar a un futuro en el que los/as estudiantes utilicen la tecnología para emitir juicios,
...
y otra vez,
podemos fomentarlo utilizando la tecnología diaria de los/as estudiantes en el aula.
Por ejemplo,
\cite{Deb2018} descubrió que la retroalimentación en tiempo real sobre los ejercicios en clase,
usando los dispositivos móviles de los/as estudiantes, mejoró la retención de conceptos y 
la participación de los/as estudiantes, al tiempo que redujo las tasas de fracaso.
...
podemos terminar aprendiendo tanto como ellos/as.
...
luego intercambia el video con un/a compañero/a
...
¿Con cuál estás menos alineado/a?
...
explica cómo y por qué las escuelas están colocando a los/as estudiantes que no aprueban los cursos presenciales en cursos en línea
...
\item
  Como una clase,
  ¿Crees que sería un beneficio real para los/as estudiantes o no?
