...
A pesar de la explosión en torno a la inteligencia artificial,\index{inteligencia artifial (explosión de)}
...
por favor adopta un Código de Conducta como el de \appref{s:conduct}\index{Código de Conducta}
...
le da a cada docente la oportunidad de descansar su voz
