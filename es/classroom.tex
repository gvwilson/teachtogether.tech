...
Originalmete creada por Eric Mazur en Harvard~\cite{Mazu1996},\index{Mazur, Eric}
...
Asi como
\hreffoot{https://www.youtube.com/watch?v=2LbuoxAy56o}{este video} muestra,
...
\begin{aside}{Falsos principiantes}
  Un \gref{g:falso-principiante}{false beginner} es alguien
...
y lo que escriben sus compañeros (\secref{s:architecture-brain}).
...
pero es carga extraña para ellas. (\chapref{s:architecture}).
...
y algunas de las otras cosas que se describen en \secref{s:checklists-events}.
...
y que sea más fácil para los estudiantes emparejarse entre sí (\secref{s:classroom-mixed}).
...
\exercise{¿Puedo conducir?}{pares}{10}
...
Mira \hreffoot{https://www.youtube.com/watch?v=vgkahOzFH2Q}{este video} de pair programming
