...
El capítulo anterior describió cómo practicar enseñar una lección
...
de la misma manera que las leyes contra el robo evitan que las personas roben,
...
\item[Hazlo frente a testigos.]
  ...
  tener a alguien más presente asegura que
...
Sin embargo,
esto hace que la clase dependa del WiFi\index{WiFi institucional (peligros del)}
