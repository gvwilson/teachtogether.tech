...
Etiquetar sub\-objetivos funciona porque agrupar los pasos relacionados en fragmentos con nombre (\secref{s:memory-seven-plus-or-minus})\index{fragmentos de código}
