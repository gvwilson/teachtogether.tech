...
capturas de pantalla que de uno que únicamente tiene narración o capturas (pero no ambos elementos),
...
es dar a tus estudiantes una serie de ejemplos desvanecidos \grefdex{g:faded-example}{\emph{faded examples en inglés}}{faded example}.
