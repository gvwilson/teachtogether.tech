...
\noindent
Por ejemplo, mi máquina nocional para \emph{Python} es:\index{emph\{Python}}
...
\figpdf{figures/bathtub.pdf}{Hielo en un recipiente}{f:models-bathtub}{Esquema de un recipiente con agua y un bloque de hielo.}
...
¿En qué difiere una máquina nocional para un lenguaje basado en bloques como Scratch\index{emph\{Scratch}} de la máquina nocional para Python?\index{emph\{Python}}
...
Los mapas conceptuales se usan para representar un modelo mental por medio de nodos que representan conceptos y enlaces que representan relaciones. Las relaciones habilitan recordar los conceptos. Estos mapas también ayudan a diseñar una lección siguiendo las relaciones.}
