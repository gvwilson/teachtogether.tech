...
\item[\grefdex{g:novice}{Personas novatas}{novice}]
no saben qué es lo que no saben,
es decir, aún no tienen un modelo mental utilizable del dominio del problema.  

\item[\grefdex{g:competent-practitioner}{Practicantes competentes}{competent practitioner}]
...
\item[\grefdex{g:expert}{Personas expertas}{expert}]
...
\hreffoot{https://swcarpentry.github.io/shell-novice-es/}{la lección sobre la consola Unix} de Software Carpentry
...
Este fenómeno se llama el \gref{g:expertise-reversal}{el efecto inverso de la experiencia} ~\cite{Kaly2003},
...
(de manera que pueda ser usada en grupos).\index{formative assessment!requirements}
El tipo de evaluación formativa más ampliamente usado es probablemente
el cuestionario de opciones múltiples (COM).\index{multiple choice question}
...
El ejemplo más conocido es el
  \grefdex{g:concept-inventory}{inventario del concepto de fuerza}{concept inventory}~\cite{Hest1992},
...
La \secref{s:classroom-peer} describe un método de enseñanza poderoso y basado en evidencias, construido a partir de estas simples ideas. 
...
Las evaluaciones formativas de una lección deberían preparar a los/las estudiantes para su evaluación sumativa:
...
\noindent
Por ejemplo, mi máquina nocional para Python es:\index{Python}
...
\exercise{Síntomas de ser una persona novata}{clase completa}{5}
...
La gente que hace esto generalmente dice cosas que\hreffoot{https://es.wikipedia.org/wiki/Ni_siquiera_es_falso}{ni siquiera son falsas}.
Como clase,
...
\exercise{Pensar en las cosas}{clase completa}{15}
...
Cuando el hielo se derrite, ¿el nivel de agua aumenta (de manera que el recipiente rebasa)?, ¿el nivel de agua baja?, ¿o se mantiene igual(\figref{f:models-bathtub})?

\figpdf{../figures/bathtub.pdf}{Hielo en un recipiente}{f:models-bathtub}
...
\exercise{Una progresión diferente}{individuos}{15}
El modelo de desarrollo de habilidades de persona novata-competente-experta
es a veces llamado
\hreffoot{https://es.qwe.wiki/wiki/Dreyfus_model_of_skill_acquisition}{modelo Dreyfus}.
Otra progresión comúnmente utilizada es el modelo de las \hreffoot{https://es.wikipedia.org/wiki/Cuatro_etapas_de_competencia}{cuatro etapas de la competencia}:
...
\exercise{¿Qué tipo de computación?}{individuos}{10}
...
\exercise{Tu modelo ahora}{clase completa}{5}
...
¿En qué difiere una máquina nocional para un lenguaje basado en bloques como Scratch\index{Scratch} de la máquina nocional para Python?\index{Python}
...
\exercise{Disfrutar sin aprender}{individuos}{5}
...
\figpdfhere{../figures/conceptmap-mental-models.pdf}{Conceptos: modelos mentales}{f:models-concept-map}

\figpdfhere{../figures/conceptmap-assessment.pdf}{Conceptos: evaluación}{f:models-formative-assessment}
