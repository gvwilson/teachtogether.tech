...
\item
  \glossref{g:content-knowledge}{content knowledge}, such as the
  ``what'' of programming;

\item
  \glossref{g:general-pedagogical-knowledge}{general pedagogical
    knowledge}, i.e., an understanding of the psychology of learning;
  and
...
the cartoon in \figref{f:performance-feedback-feelings} suggests, it
...
videos of programming instruction is given in \appref{s:teacheval}.  A
...
\begin{callout}{Question Budgets}
  ...
  Rubrics like the one in \appref{s:teacheval} have a tendency to grow
...
preparation for co-teaching (\secref{s:classroom-together}): teachers
...
time debugging; novices spend much more (\secref{s:pck-debug}), but
...
taking together (\secref{s:classroom-notetaking}). This is more
...
which helps with retention (\secref{s:load-split-attention}) and
...
\begin{enumerate}
  ...
  \item
    ...
    \secref{s:performance-feedback}, then make a note of what you
