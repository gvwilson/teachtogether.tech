...
\secref{s:community-learn-then-do} said that the first step in
...
As \chapref{s:community} said, the starting point is to find out what
...
\secref{s:partner-schools}.  Which of these apply to you and your
...
aren't adopted given in \secref{s:partner-final}.  Which of these have
