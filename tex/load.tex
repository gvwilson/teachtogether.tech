...
sheet of paper (\secref{s:classroom-practices}). It also encourages
...
\begin{callout}{Efficiency vs.\ Extent}
  ...
  see in \chapref{s:pck}, deconstructing code by tracing it or
...
\secref{s:individual-strategies}), researchers' perspectives may
...
\begin{callout}{Cognitive Apprenticeship}
  ...
  in \secref{s:individual-strategies}.
...
Blind Spot'' in \secref{s:memory-exercises} will give you an idea
