\chaplbl{In the Classroom}{s:classroom} % FIXME
...
\begin{aside}{Helping}
  ...
  the shared notes (\secref{s:classroom-notetaking}) and either
...
\item
  ...
  (\secref{s:classroom-notetaking}), keep an eye on the students
...
heed the advice in \secref{s:classroom-innovate} and stick to
...
things described in the travel kit checklist in \secref{s:checklists-events}.
...
how much they actually learn (\secref{s:pck-now}). Instead, you have
