...
\cite{Wlod2017}. According to \href{https://en.wikipedia.org/wiki/Self-determination_theory}{self-determination
...
We said in Section~\ref{s:intro-code-of-conduct} that classes should
...
As discussed in Section~\ref{s:classroom-enforce}, the details of the
