...
to \hyperlink{g:free-range-learner}{free-range learners}.
...
\begin{aside}{This Book Belongs to Everyone}

This book is a community resource.
Parts of it were originally created for
\href{http://carpentries.github.io/instructor-training/}{the Software Carpentry instructor training program},
which has been run over several hundred times since 2012,
and all of it can be freely distributed and re-used
under the \href{https://creativecommons.org/licenses/by-nc/4.0/}{Creative Commons Attribution-NonCommercial 4.0} license
(Appendix~\ref{s:license}).
Please see \url{http://teachtogether.tech/} for an online version.

Contributions of all kinds are welcome.
All proposed contributions will be managed in the same way as edits to Wikipedia or patches to open source software,
and all contributors will be credited for their work each time a new version is released.
Please see Appendix~\ref{s:joining} for details
and Section~\ref{s:joining-covenant} for our code of conduct.

\end{aside}

\section{Who You Are}\label{s:intro-audience}

Section~\ref{s:process-personas} explains how to figure out who your learners are.
The four this book is for are all \hyperlink{g:end-user-teacher}{end-user teachers}:
...
\item[Samira]
  ...
  and feels a lot of \hyperlink{g:impostor-syndrome}{impostor syndrome}.
...
\item
  \href{http://carpentries.github.io/instructor-training/}{The Carpentries instructor training},
...
\item
  \cite{Majo2015}, \cite{Broo2016}, \cite{Berg2012}, \cite{Rice2018}, and \cite{Wein2018b}.
  These books can be used on their own,
  but may make more sense once you have given you a framework for understanding them.

\item
  \cite{DeBr2015},
  which explains what \emph{is} true about educational by explaining what \emph{isn't},
  and \cite{Dida2016},
...
\item
  ...
  \href{https://medium.com/bits-and-behavior/mindstorms-what-did-papert-argue-and-what-does-it-mean-for-learning-and-education-c8324b58aca4}{Andy Ko's excellent description}
...
\item
  ...
  These three short books explain why so many attempts at educational reform have failed over the past forty years,
...
Those who want more academic material may also find \cite{Guzd2015a,Hazz2014,Sent2018,Finc2019,HPL2} rewarding,
while \href{http://computinged.wordpress.com}{Mark Guzdial's blog} has consistently been informative and thought-provoking.
...
However,
as Benjamin Doxtdator \href{http://www.longviewoneducation.org/field-guide-jobs-dont-exist-yet/}{pointed out},
...
And as \href{https://computinged.wordpress.com/2017/10/18/why-should-we-teach-programming-hint-its-not-to-learn-problem-solving/}{Mark Guzdial points out},
...
Part of what motivates me to teach is the hope that if enough people understand how to make technology work for them,
we will be able to build a society in which \emph{all} of the reasons above are valued and rewarded (Chapter~\ref{s:finale}).
...
Please read the caveats in Section~\ref{s:classroom-prior} before doing this.

\subsection{Highs and Lows (whole class/5)}\label{x:intro-highs-and-lows-whole-class}

Write brief answers to the following questions and share with your peers.
(If you are taking notes together online as described in Section~\ref{s:classroom-notetaking},
...
\subsection{Know Thyself (whole class/10)}\label{x:intro-know-thyself-whole-class}
...
\subsection{Why Learn to Program? (individual/20)}\label{why-learn-to-program-individual}

Re-read Guzdial's list of reasons to learn to program in Section~\ref{s:intro-why},
then draw a $3{\times}3$ grid whose axes are labelled ``low'', ``medium'', and ``high''
