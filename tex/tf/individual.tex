...
The key to getting more out of learning is \gref{g:metacognition}{metacognition},
...
Researchers distinguish between \gref{g:near-transfer}{near transfer},
which occurs between similar or related areas like fractions and decimals in mathematics,
and \gref{g:far-transfer}{far transfer},
...
\gref{g:read-cover-retrieve}{Read-cover-retrieve} is a quick alternative to flash cards.
...
which in turn is better than A-A-B-B-C-C \cite{Rohrer2015}.
...
As discussed in \secref{s:load-split-attention},
...
\begin{aside}{When You Just Can't Say No}
  ...
  This is called \gref{g:ego-depletion}{ego depletion} \cite{Mill2016a},
