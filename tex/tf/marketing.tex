...
\gref{g:marketing}{marketing} seriously, not least because it's perceived
...
As with the lesson design process in Chapter~\ref{s:process}, you should
...
will meet. You should also write a set of \gref{g:elevator-pitch}{elevator
...
A \gref{g:brand}{brand} is someone's first reaction to a mention
...
\gref{g:positioning}{positioning} becomes more important.
...
\begin{aside}{Mail Out of the Blue}
