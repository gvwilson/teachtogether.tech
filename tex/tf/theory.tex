...
scope of \gref{g:educational-psychology}{educational psychology}, two
specific perspectives have primarily influenced my teaching. The first
is \gref{g:cognitivism}{cognitivism}, which focuses on things like pattern
...
\gref{g:situated-learning}{situated learning}, which focuses on bringing
...
include \gref{g:behaviorism}{behaviorism} (which treats education as
stimulus/response conditioning), \gref{g:constructivism}{constructivism}
(which considers learning an active process during which learners
construct knowledge for themselves), and
\gref{g:connectivism}{connectivism} (which holds that knowledge is
...
Doing this is called \gref{g:instructional-design}{instructional design}.
...
The term \gref{g:computational-thinking}{computational thinking} is
...
think in terms of getting learners to understand a \gref{g:notional-machine}{notional
