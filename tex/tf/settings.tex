...
% temporary replacement for \hyperlink and \hypertarget
\newcommand{\hyperlink}[2]{\textbf{#2}}
\newcommand{\hypertarget}[2]{#2}

% temporarily provide \href
\newcommand{\href}[2]{{#2}\footnote{\url{#1}}}

% temporarily provide \url
...
\newcommand\FMCTsub{\fontsize{12}{12}\sffamily\raggedright\selectfont}
\newcommand\FMCTauth{\fontsize{16}{14}\sffamily\raggedright\selectfont}
