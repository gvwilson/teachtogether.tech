...
They are usually designed to test the lower levels of Bloom's Taxonomy (\secref{s:process-objectives}),
...
\grefdex{g:parsons-problem}{Parsons Problems}{Parsons Problem} also avoid
the ``blank screen of terror'' problem (\chapref{s:architecture})
...
\begin{aside}{Labelling a Diagram}
  \figref{f:exercises-labelling} shows
...
\figpdf{figures/labelling.pdf}{Labelling a Diagram}{f:exercises-labelling}
...
use calibrated peer review (\secref{s:individual-peer})
