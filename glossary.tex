...
\gitem{g:active-teaching}{Active teaching} An approach to teaching in which the
...
\gitem{g:end-user-teacher}{End-user teacher} By analogy with \emph{end-user
...
\gitem{g:functional-programming}{Functional programming} A style of programming
...
\gitem{g:lateral-knowledge-transfer}{Lateral knowledge transfer} The
...
\gitem{g:persistent-memory}{Persistent memory} see \emph{long-term memory}.
...
\gitem{g:productive-failure}{Productive failure} A situation in which learners
  ...
  See also \emph{Zone of Proximal Development}.
...
a more experienced mentor.  See also \emph{productive failure}.
