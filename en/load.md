...
More specifically, posited that people have to deal with three things
...
2.  Define the audience for your examples. For example, are these
...
3.  Show your example to a partner, but do *not* tell them what level it
