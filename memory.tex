...
As examples,
\figref{f:memory-seasons} shows why the Earth has seasons,
and \appref{s:conceptmaps} presents concept maps for several key ideas in this book.

\figlbl{figures/seasons.pdf}{Concept Map for Seasons (from \url{https://cmap.ihmc.us/})}{f:memory-seasons}
...
\item[Aiding communication with learners.]
  ...
  We will return to this idea in \secref{s:load-split-attention}.
...
One way to do this is to identify \hreffoot{https://en.wikipedia.org/wiki/Software\_design\_pattern}{design patterns},
...
\exercise{A Concept Map for This Chapter}{individual}{30}

After you have finished going through this chapter,
draw a concept map for it and send it to us (\appref{s:joining}).
