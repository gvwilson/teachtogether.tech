...
effortless: in many cases, they instantly know what the right answer is~\cite{Parn2017}.
...
be useful in some contexts, as can decision trees like~\cite{Abel2009} that shows how to choose the right kind of chart for
...
memory}. It is much faster, but also much smaller:~\cite{Mill1956}
estimated that the average adult's working memory
