...
\figpdf{figures/conditionals.pdf}{Learning Trajectory for Conditions (from~\cite{Rich2017})}{f:pck-trajectory}
...
\cite{Sorv2018} presents over 40 other misconceptions that teachers can also try to clear up,
...
\figimg{figures/interventions-scaled.png}{Effectiveness of Interventions (from \cite{Viha2014})}{f:pck-interventions}
