...
\item
  ...
  and so on.
  Drawing concept maps can help a lot at this stage (\secref{s:memory-concept-maps}).

\item
  Create a summative assessment (\secref{s:models-formative-assessment})
...
One way to do this is to write two or three \gref{g:learner-persona}{learner personas}
...
a course description should also have \gref{g:learning-objective}{learning objectives}.
...
This fits well with Caulfield's theory of \hreffoot{https://hapgood.us/2016/05/13/choral-explanations/}{choral explanations},
...
\item
  Many instructors have concerns about having their (lack of) knowledge judged by their peers
