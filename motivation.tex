\chaplbl{Motivation and Demotivation}{s:motivation} % FIXME
...
\cite{Wlod2017}. According to \hreffoot{https://en.wikipedia.org/wiki/Self-determination\_theory}{self-determination
...
\begin{aside}{The Problem of Grades}
  ...
  example in discussion of extrinsic motivation,
  but as~\cite{Mill2016a}
  observes, they aren't going to go away any time
  ...
  motivation in institutional education, and the \hreffoot{https://en.wikipedia.org/wiki/Constructive\_alignment}{constructive
    alignment} approach advocated in~\cite{Bigg2011} seeks to bring learning activities and learning
...
\begin{aside}{Not Just for Students}
  ...
  to co-teach (\secref{s:classroom-together}): just as having a
...
once mastered'' (\figref{f:motivation-what}).

\figlbl{figures/what-to-teach.pdf}{What to Teach}{f:motivation-what}
...
\chapref{s:memory}, this signals to the learner that the teacher
...
\cite{Ford2016} found that five barriers to contribution on \hreffoot{https://stackoverflow.com/}{Stack
...
\secref{s:motivation-inclusivity}, and doing so improves outcomes
...
under-represented groups: as discussed in \secref{s:pck-now},
...
The Ada Initiative has created some \hreffoot{https://www.usenix.org/blog/impostor-syndrome-proof-yourself-and-your-community}{guidelines} for
...
noted in \secref{s:performance-live}, your typos show your class
...
\hreffoot{https://www.psychologytoday.com/blog/rabble-rouser/201512/is-stereotype-threat-overcooked-overstated-and-oversold}{questions} about the replicability of
...
programmers and others aren't. Guzdial has called this \hreffoot{https://cacm.acm.org/blogs/blog-cacm/189498-top-10-myths-about-teaching-computer-science/fulltext}{the biggest
...
As with stereotype threat, \hreffoot{https://educhatter.wordpress.com/2017/03/26/growth-mindset-is-the-theory-flawed-or-has-gm-been-debased-in-the-classroom/}{there are concerns}
...
code. Someone using a \hreffoot{https://en.wikipedia.org/wiki/Screen\_reader}{screen reader} would therefore
...
\begin{aside}{It Helps Everyone}
  \hreffoot{https://en.wikipedia.org/wiki/Curb\_cut}{Curb cuts} (the small sloped ramps joining a sidewalk to
...
\emph{\hreffoot{https://en.wikipedia.org/wiki/Nothing\_About\_Us\_Without\_Us}{nihil de nobis, sine nobis}} (literally, ``nothing
...
Each of \hreffoot{https://accessibility.blog.gov.uk/2016/09/02/dos-and-donts-on-designing-for-accessibility/}{these posters} offers do's and
...
For example, sites like \hreffoot{http://webaim.org/}{WebAIM} allow you to check how
...
We said in \secref{s:classroom-coc} that classes should
enforce a Code of Conduct like the one in \appref{s:conduct}. This
...
\hreffoot{https://butyoudontlooksick.com/articles/written-by-christine/the-spoon-theory/}{spoons} as a way to explain what it's like to
...
Spoons are often invisible, but as \hreffoot{https://patitsas.blogspot.com/2018/03/spoons-are-form-of-capital.html}{Elizabeth Patitsas has
...
percentage seen in the mid-1980s (\figref{f:motivation-gender}). And
...
\figlbl{figures/enrollment.png}{Degrees Awarded and Female Enrollment ({[}Robe2017{]}(\#BIB))}{f:motivation-gender}
...
privilege (\secref{s:classroom-mixed}) may not be any one person's
fault, but they are everyone's responsibility. \hreffoot{https://frameshiftconsulting.com/ally-skills-workshop/}{This
...
Paloma Medina identifies \hreffoot{https://www.palomamedina.com/biceps}{six core needs} for people at
...
\hreffoot{https://mobile.nytimes.com/2016/04/10/upshot/why-talented-black-and-hispanic-students-can-go-undiscovered.html}{this article} by Cameron Cottrill, and then
...
\hreffoot{https://www.destroyallsoftware.com/blog/2018/a-case-study-in-not-being-a-jerk-in-open-source}{This short article} by Gary Bernhardt rewrites an
unnecessarily hostile message to be less rude. Using it as a model,
find something unpleasant on \hreffoot{https://stackoverflow.com/}{Stack Overflow} or some
...
rank it according to the do's and don'ts in \hreffoot{https://accessibility.blog.gov.uk/2016/09/02/dos-and-donts-on-designing-for-accessibility/}{these
