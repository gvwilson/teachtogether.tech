...
\figref{f:motivation-women-in-cs} graphically illustrates the effects of computing's exclusionary culture
on women.

\figlbl{figures/women-coding.png}{Female Computer Science Majors in the US (from \url{https://www.npr.org/sections/money/2014/10/21/357629765/when-women-stopped-coding})}{f:motivation-women-in-cs}
